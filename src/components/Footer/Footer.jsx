                ...
                <Row>
                    ...
                    <Col className="d-flex flex-column">
                        ...
                        <div className={styles.iconcontainer}>
                            ...
                            <Nav>
                                <Nav.Link href="https://www.facebook.com/" className={styles.contenttext}>
                                    UITGear Fanpage
                                </Nav.Link>
                            </Nav>
                        </div>
                        <div className={styles.iconcontainer}>
                            ...
                            <Nav>
                                <Nav.Link href="https://www.youtube.com/" className={styles.contenttext}>
                                    UITGear Instagram
                                </Nav.Link>
                            </Nav>
                        </div>
                        <div className={styles.iconcontainer}>
                            ...
                            <Nav>
                                <Nav.Link href="https://www.instagram.com/" className={styles.contenttext}>
                                    UITGear Youtube
                                </Nav.Link>
                            </Nav>
                        </div>
