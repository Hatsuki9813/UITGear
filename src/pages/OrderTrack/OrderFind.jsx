...
export default function OrderFind() {
    return (
        <div className={styles.OrderFindContainer}>
            ...
            <p className={styles.contenttext}>Để theo dõi đơn hàng của bạn, vui lòng nhập ID đơn hàng của bạn vào trường nhập bên dưới và nhấn nút “Theo dõi đơn hàng”. Thông tin này đã được trao cho bạn trên biên nhận và trong email xác nhận mà lẽ ra bạn phải nhận được.</p>
            <Form>
